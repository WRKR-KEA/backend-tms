...
public class ManagerTicketAllGetUseCase {
    ...
    public PageResponse<ManagerTicketAllGetResponse> getManagerTicketList(Long managerId, Pageable pageable, TicketStatus status, String query, SortType sortType) {
