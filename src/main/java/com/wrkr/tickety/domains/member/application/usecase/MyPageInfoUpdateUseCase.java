...
public class MyPageInfoUpdateUseCase {
    ...
    public PkResponse updateMyPageInfo(String memberId, MyPageInfoUpdateRequest request) {
        Optional<Member> member = memberGetService.byMemberId(PkCrypto.decrypt(memberId));
