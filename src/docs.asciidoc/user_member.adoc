...
include::{snippets}/UserMember/updatePassword/Success/request-body.adoc[]
...
include::{snippets}/UserMember/updatePassword/Failure/UnmatchedPassword/request-body.adoc[]
...
include::{snippets}/UserMember/updatePassword/Failure/MemberNotFound/request-body.adoc[]
...
include::{snippets}/UserMember/updatePassword/Failure/InvalidPasswordFormat/request-body.adoc[]
